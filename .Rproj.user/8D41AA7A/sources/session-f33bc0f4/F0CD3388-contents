...
<div class="figure">
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-9-1.png" alt="Coefficients du filtre avec cosinus \textit{taper} pour l'abondance de Synechococcus à Banyuls (haut). Fonctions de fréquence réponse désirée (en bleu, pointillé) et atteinte (en rouge) pour l'abondance de Synechococcus à Banyuls avec fréquence en cycle annuel (bas). `\(L=3\)` et `\(M=1000\)`" width="672" />
